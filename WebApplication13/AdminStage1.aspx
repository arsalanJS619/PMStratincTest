<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminStage1.aspx.cs" Inherits="WebApplication13.AdminStage1" %>
                            ...
                            <form action="#">
                                <div class="row">
                                   ...
                                   <div class="col-12"></div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:TextBox ID="ApplicantIDs" Font-Size="Large" runat="server" AutoPostBack="true" CssClass="form-control" OnTextChanged="GetStuStage1Data" style="width:500px;height:45px" />
<%--                                        <input runat="server"  class="form-control" id="ApplicantID" onchange="GetStuStage1Data" style="width:500px" />--%>
                                    </div> 
                                    
                                     <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:Label Font-Size="X-Large" Font-Bold="true" Text="Applicant Name" runat="server"></asp:Label>
                                        </div>
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:TextBox ID="ApplicantName" Font-Size="Large" runat="server" AutoPostBack="true" CssClass="form-control" style="width:500px;height:45px" />
<%--                                        <input runat="server"  class="form-control" id="ApplicantID" onchange="GetStuStage1Data" style="width:500px" />--%>
                                    </div> 
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:TextBox ID="Country" Font-Size="Large" runat="server" AutoPostBack="true" CssClass="form-control" style="width:500px;height:45px" />
<%--                                        <input runat="server"  class="form-control" id="ApplicantID" onchange="GetStuStage1Data" style="width:500px" />--%>
                                    </div> 
                                    ...
                                    <div class="input-group my-colorpicker2 colorpicker-element">
                                        <asp:TextBox CssClass="form-control" ID="SubmissionDates" Font-Size="Large" Width="300px" Style="width:400px" runat="server" MaxLength="11" onfocus="checkDateEntryMode(this)" onblur="checkDate(this);" onpaste="return false" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"></asp:TextBox>
                                        <div class="input-group-addon">
                                            &nbsp;<asp:Image ID="ImgDateofRegistration" Width="25px" runat="server" ImageUrl="images/Calendar_scheduleHS.png" />
                                        </div>
                                    </div>
                                    <ajaxToolkit:CalendarExtender PopupPosition="BottomRight" ID="CESubmission" runat="server" TargetControlID="SubmissionDates" PopupButtonID="ImgDateofRegistration" Format="dd-MMM-yyyy"></ajaxToolkit:CalendarExtender>
                                 ...
                                 <%--    <div class="input-group my-colorpicker2 colorpicker-element" style="width: 75px">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                       <asp:DropDownList runat="server" class="form-control" id="OurAction" Width="500px" ForeColor="Black">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="Stage1Remarks" style="width:500px;font-size:large"/>
                                    </div>  
