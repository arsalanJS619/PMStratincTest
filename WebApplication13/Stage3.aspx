<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stage3.aspx.cs" Inherits="WebApplication13.Stage3" %>
                 ...
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        <div class="pages_links">
                           <h1 style="color:white">Stage 3</h1>
                            ...
                            <form action="#">
                                <div class="row">
                                   ...
                                   <div class="col-12"></div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="ApplicantID" style="width:500px;color:darkgray" readonly="true" disabled="disabled" />
                                    </div>  
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="AcceptanceDate" maxlength="11" style="width:500px;color:darkgray" disabled="disabled" readonly="true" />
                                    </div>                                    
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                         <input type="checkbox" class="defaultCheckbox" runat="server" readonly="true" id="LetterIssued" disabled="disabled" style="width: 25px; height: 25px;float:left"/>
                                    </div>  
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="SemesterStartDate" maxlength="11" style="width:500px;color:darkgray" disabled="disabled" readonly="true" />
                                    </div>     
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="FeeToBePaidBy" disabled="disabled" maxlength="11" style="width:500px;color:darkgray"  readonly="true"/>
                                    </div>     
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="Remarks" style="width:500px;color:darkgray" disabled="disabled" readonly="true"/>
                                    </div>  
