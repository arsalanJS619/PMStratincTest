<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentReg.aspx.cs" Inherits="WebApplication13.StudentReg" %>
        ...
        <div class="row">  
            ...
            <%--<div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <div class="contact_form_wrapper">
                    <h3 class="title">Fill Details Below</h3>
                        ...
                        <div class="contact_form">
                            <form action="#">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input type="email" runat="server" class="form-control" id="email" placeholder="Your E-mail"/>
                                    </div>    
                                    
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                   <asp:DropDownList runat="server" ID="ddl11">
...
<%--                                    
<div class="col-12 col-sm-12 col-md-6 form-group">
    <asp:DropDownList runat="server" ID="ddl2" CssClass="form-control">
    <asp:ListItem>test0000</asp:ListItem>
