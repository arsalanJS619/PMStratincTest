<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactPage.aspx.cs" Inherits="WebApplication13.ContactPage" %>
                            ...
                            <div class="tab-pane fade" id="panel2" role="tabpanel">
                                <form action="#" class="register">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                        <asp:DropDownList ID="ddl2" runat="server" CssClass="form-control" Width="30px">
...
<asp:DropDownList runat="server" Width="100px" CssClass="form-control">
    <asp:ListItem>test1</asp:ListItem>
    <asp:ListItem>test2</asp:ListItem>
