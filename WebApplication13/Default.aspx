                ...
                <ul>
                    <li data-index="rs-1706" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme"
                            ...
                            We are pmstratinc....helping everyone to live
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme"
                            ...
                            data-paddingleft="[0,0,0,0]"
                            style="z-index: 5; font-family: 'Roboto', sans-serif; font-weight: 900; white-space: nowrap; text-transform: left;">
                            a hassle free life in Canada
                   
                        </div>

                        <div class="tp-caption NotGeneric-Title   tp-resizeme"
                            id="slide-3045-layer-25"
                            data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                            data-y="['middle','middle','middle','middle']" data-voffset="['120','140','120','140']"
                            data-fontsize="['65','120','100','70']"
                            data-lineheight="['70','120','70','70']"
                            data-width="none"
                            data-height="none"
                            ...
                            data-paddingbottom="[10,10,10,10]"
                            data-paddingleft="[0,0,0,0]"
                            style="z-index: 5; font-family: 'Roboto', sans-serif; color: red; font-weight: 900; white-space: nowrap; text-transform: left;">
                            Our Services
                    ...
                    <li data-index="rs-1708" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1000" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme" 
                        id="slide-3045-layer-15" 
                        data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                        data-y="['middle','middle','middle','middle']" data-voffset="['120','140','-10','-40']" 
                        data-fontsize="['65','120','100','70']"
                        data-lineheight="['70','120','70','70']"
                        data-width="none"
                        data-height="none"
                        ...
                        style="z-index: 5; font-family:'Roboto', sans-serif; color:red; font-weight: 900; white-space: nowrap;text-transform:left;">Our Services
                    </div>
                        <!-- LAYER NR. 4 -->
                        <%--<div class="tp-caption rev-btn rev-btn left_btn" 
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
                                                ...
                                                <button type="submit" runat="server" onserverclick="RegBtn_Click" onclick="RegBtn_Click" class="btn btn-default login_btn">Login</button>
                                            </div>
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                ...
                                <div class="tab-pane fade" id="panel2" role="tabpanel">
                                    <form action="#" class="register">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                     <label class="control-label">Education Services</label>

                                                    <checkbox id="ChkEdu" runat="server" class="form-control" 
                                                        />
<%--                                                    <input type="password" id="Password1" runat="server" class="form-control" placeholder="Password"/>--%>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                   <label class="control-label">Immigration Services</label>

   <checkbox id="ChkImg" runat="server" class="form-control" 
                                                        />
<%--                                             <%--                                                    <input type="password" id="Password1" runat="server" class="form-control" placeholder="Password"/>--%>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label class="control-label">Settlement Services</label>

   <checkbox id="ChkSetl" runat="server" class="form-control" 
                                                        />
<%--                                             <%--                                                    <input type="password" id="Password1" runat="server" class="form-control" placeholder="Password"/>--%>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-12 col-md-12 col-lg-12 d-flex justify-content-between login_option">
                                                <button type="submit" runat="server" id="RegBtn1" class="btn btn-default login_btn" onsubmit="RegBtn_Click" onclick="RegBtn_Click" onserverclick="RegBtn_Click">Register</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <div class="container">            
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                <div class="title">
                    <h2>Take The First Step To Learn With <span style="color:red">Pmstratinc</span></h2>
