<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminStage3.aspx.cs" Inherits="WebApplication13.AdminStage3" %>
...
<%--                                <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>--%>
            ...
            <div class="intro_wrapper" style="background: url('../images/banner/stage3.jpg') no-repeat center center !important;">
        <div class="container">  
            <div class="row">        
...
<%--                    <h2 class="title">Fill Details</h2>--%>
                    <div class="leave_comment">
                        <div class="contact_form">
                            <form action="#">
                                <div class="row">
                                    <span style="font-weight:bold" class="title">APPLICATION ACCEPTANCE</span>
                                   <div class="col-12"></div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                    <asp:TextBox ID="ApplicantID" Font-Size="Large" runat="server" AutoPostBack="true" CssClass="form-control" OnTextChanged="GetStuStage3Data" style="width:500px;height:45px" />

<%--                                      <asp:TextBox runat="server" CssClass="form-control" ID="ApplicantID" OnTextChanged="GetStuStage3Data"  Width="500px" />--%>
                                    </div>  

                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:Label Font-Size="X-Large" Font-Bold="true" Text="Acceptance Date" runat="server"></asp:Label>
                                        </div>
                                              
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                         <td class="col-12 col-sm-12 col-md-6 form-group">
                                    <div class="input-group my-colorpicker2 colorpicker-element">
                                        <asp:TextBox class="form-control" ID="AcceptanceDates" Font-Size="Large" Width="75px" Style="z-index: auto;" runat="server" MaxLength="11" onfocus="checkDateEntryMode(this)" onblur="checkDate(this);" onpaste="return false" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"></asp:TextBox>
                                        <div class="input-group-addon">
                                            &nbsp;<asp:Image ID="ImgDateofRegistration" Width="25px" runat="server" ImageUrl="images/Calendar_scheduleHS.png" />
                                        </div>
                                    </div>
                                    <ajaxToolkit:CalendarExtender PopupPosition="BottomRight" ID="CESubmission" runat="server" TargetControlID="AcceptanceDates" PopupButtonID="ImgDateofRegistration" Format="dd-MMM-yyyy"></ajaxToolkit:CalendarExtender>
                                             </td>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:Label Font-Size="X-Large" Font-Bold="true" Text="Letter Issued" runat="server"></asp:Label>
                                        </div>
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                         <input type="checkbox" class="defaultCheckbox" runat="server" id="LetterIssued" style="width: 25px; height: 25px;float:left"/>
                                    </div>  
                                     ...
                                     <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:Label Font-Size="X-Large" Font-Bold="true" Text="Semester Start Date" runat="server"></asp:Label>
                                        </div>
                                      <div class="col-12 col-sm-12 col-md-6 form-group">
                                         <td class="col-12 col-sm-12 col-md-6 form-group">
                                    <div class="input-group my-colorpicker2 colorpicker-element">
                                        <asp:TextBox class="form-control" ID="SemesterStartDate" Font-Size="Large" Width="75px" Style="z-index: auto;" runat="server" MaxLength="11" onfocus="checkDateEntryMode(this)" onblur="checkDate(this);" onpaste="return false" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"></asp:TextBox>
                                        <div class="input-group-addon">
                                            &nbsp;<asp:Image ID="SemImgDateofRegistration" Width="25px" runat="server" ImageUrl="images/Calendar_scheduleHS.png" />
                                        </div>
                                    </div>
                                    <ajaxToolkit:CalendarExtender PopupPosition="BottomRight" ID="SemStartCalendarExtender" runat="server" TargetControlID="SemesterStartDate" PopupButtonID="SemImgDateofRegistration" Format="dd-MMM-yyyy"></ajaxToolkit:CalendarExtender>
                                             </td>
                                        </div>
                                     ...
                                     <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <asp:Label Font-Size="X-Large" Font-Bold="true" Text="Fee To Be Paid By" runat="server"></asp:Label>
                                        </div>
                                     <div class="col-12 col-sm-12 col-md-6 form-group">
                                         <td class="col-12 col-sm-12 col-md-6 form-group">
                                    <div class="input-group my-colorpicker2 colorpicker-element">
                                        <asp:TextBox class="form-control" ID="FeeToBePaidBy" Font-Size="Large" Width="75px" Style="z-index: auto;" runat="server" MaxLength="11" onfocus="checkDateEntryMode(this)" onblur="checkDate(this);" onpaste="return false" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;"></asp:TextBox>
                                        <div class="input-group-addon">
                                            &nbsp;<asp:Image ID="FeeImgDateofRegistration" Width="25px" runat="server" ImageUrl="images/Calendar_scheduleHS.png" />
                                        </div>
                                    </div>
                                    <ajaxToolkit:CalendarExtender PopupPosition="BottomRight" ID="FeeToBePaidCalendarExtender" runat="server" TargetControlID="FeeToBePaidBy" PopupButtonID="FeeImgDateofRegistration" Format="dd-MMM-yyyy"></ajaxToolkit:CalendarExtender>
                                             </td>
                                        </div>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 form-group">
                                        <input runat="server" class="form-control" id="Remarks" style="width:500px;font-size:large"/>
                                    </div>  
